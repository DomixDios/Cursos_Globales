<?php $pageTitle = 'Categor&iacute;as'; $extraJs = '<script src="' . BASE_URL . '/assets/js/admin.js"></script>'; ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0 fw-bold">Categor&iacute;as</h2>
...
<div class="modal fade" id="categoryModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content p-3">
            <h5 class="fw-semibold mb-3" id="categoryModalLabel">Nueva Categor&iacute;a</h5>
            <form id="catForm">
