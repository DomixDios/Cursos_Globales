    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content p-4" id="courseModalContent">
            ...
            <form id="courseForm">
                ...
                <div class="mb-3"><label class="form-label small">T�tulo</label><input type="text" name="title" class="form-control" required></div>
                <div class="mb-3"><label class="form-label small">Descripci�n corta</label><textarea name="short_description" class="form-control" rows="2"></textarea></div>
                <div class="mb-3"><label class="form-label small">Descripci�n completa</label><textarea name="description" class="form-control" rows="4"></textarea></div>
                <div class="row mb-3">
                    ...
                    <div class="col"><label class="form-label small">Categor�a</label><select name="category_id" class="form-select" id="catSelect"></select></div>
                </div>
